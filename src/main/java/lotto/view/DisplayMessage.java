...
public class DisplayMessage {
    ...
    public void displayBuyHowManyLotto(int quantity) { // 완
        System.out.println();
    ...
    public void displayWinningStatistics() { // 완
        System.out.println();
        System.out.println("당첨 통계");
        System.out.println("---");
    }

    public void displayWinningRank(HashMap<Rank, Integer> lottoResult) { // 완
    ...
    public void displayRateOfReturn(double rateOfReturn) { // 완
